...
TERMS = (
    "688884",
    "AutoPauseVideo",
    'data-sentry-element:"AutoPauseVideo"',
    'data-sentry-component:"AutoPauseVideo"',
    "video_url",
    "videoUrl",
    "poster_url",
    "posterUrl",
...
def contexts(text: str, term: str, radius: int = 7000, limit: int = 60) -> list[dict[str, Any]]:
    ...
    while len(found) < limit:
        ...
        found.append({"offset": index, "context": ctx})
...
def main() -> int:
    ...
    out = Path("gmgn_autopause_callsites.json")
    out.write_text(json.dumps(report, indent=2, ensure_ascii=False), encoding="utf-8")
    print("SCRIPTS", len(scripts))
    for hit in hits:
        print("HIT", hit["term"], hit["count"], hit["script_url"])
