...
export default function ShopPremiumLaunch() {
  ...
  return <div className="min-h-screen px-3 pt-3 pb-28 text-white bg-[#05070d]">
    ...
    <section className="shop-glass rounded-3xl p-4 mb-3 overflow-hidden relative" style={{ borderColor: "rgba(255,215,0,.34)" }}><div className="absolute -right-10 -top-12 h-44 w-44 rounded-full bg-[#FFD700]/16 blur-3xl" /><div className="relative z-10 flex items-start gap-3"><PremiumIcon tone="#FFD700"><Target size={26} className="text-[#FFD700]" /></PremiumIcon><div className="flex-1"><div className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#FFD700] mb-1">Next Arcade Game</div><h2 className="text-2xl font-black leading-tight">Dice is coming soon</h2><p className="mt-1 font-mono text-[10px] leading-relaxed text-white/50">A fast over/under dice round built for Play TC. Simple rules, server-side results, fixed house edge, and no trading charts.</p><div className="mt-3 grid grid-cols-3 gap-2 text-center"><div className="rounded-2xl border border-[#FFD700]/20 bg-[#FFD700]/8 p-2"><div className="font-mono text-[8px] text-white/35">Game</div><div className="font-black text-[#FFD700]">Dice</div></div><div className="rounded-2xl border border-[#4DA3FF]/20 bg-[#4DA3FF]/8 p-2"><div className="font-mono text-[8px] text-white/35">Uses</div><div className="font-black text-[#8BC3FF]">Play TC</div></div><div className="rounded-2xl border border-[#00F5A0]/20 bg-[#00F5A0]/8 p-2"><div className="font-mono text-[8px] text-white/35">Status</div><div className="font-black text-[#00F5A0]">Soon</div></div></div><p className="mt-3 font-mono text-[9px] leading-relaxed text-white/35">Dice will be entertainment only. CR stays tied to verified creator activity and approved content rewards.</p></div></div></section>
